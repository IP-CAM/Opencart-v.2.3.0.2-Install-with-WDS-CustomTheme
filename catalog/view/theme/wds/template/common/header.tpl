    ...
    <div id="main" class="main-fixed">
        <header>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 col-xs-12 hidden-xs">
							<div class="left-side1">
								<div id="google_translate_element" style="display:inline-block;text-top"></div>
								...
								<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>								<!-- <a href="<?php echo $register; ?>"><?php echo $text_register; ?></a> -->
								<?php echo "&ensp;&ensp;&ensp;&ensp;" ?>
								<a href="https://www.facebook.com/hoangdungtextile/"><i class="fa fa-facebook-square"></i></a>
								<?php echo "&ensp;" ?>
								<a href="https://www.facebook.com/hoangdungtextile/"><i class="fa fa fa-twitter-square"></i></a>
								<!-- <?php echo "&ensp;&ensp;&ensp;&ensp;" ?> -->
								<?php echo "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;" ?>
            ...
            <div id="header">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 logo-inner">
                            <div class="logo-store  col-md-5 col-xs-12 ">
                                <?php if ($logo) { ?>
							...
							<div class="bottom-align-text col-md-7 col-xs-12">
								<span style ="color:#7a7a7a;font-size: 23px;">Chia sẻ để thành công</span>
							</div>
                        </div>
