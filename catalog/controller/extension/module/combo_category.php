...
class ControllerExtensionModuleComboCategory extends Controller {
	public function index($setting) {
        ...
        foreach ($category_ids as $category_id) {
			$this->log->write("category_id: ".$category_id);
			$this->log->write("config_language_id: ".(int)$this->config->get('config_language_id'));
			$this->log->write("config_store_id: ".(int)$this->config->get('config_store_id'));
			
			// echo "<pre>";
			// $this->log->write(var_dump($this->model_catalog_category->getCategory($category_id)));
