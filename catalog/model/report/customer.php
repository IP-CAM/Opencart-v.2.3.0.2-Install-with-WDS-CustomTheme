...
class ModelReportCustomer extends Model {
	public function getTotalVistorToDay() {
		$sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "customer_counter` WHERE TJD = CURDATE()";
	...
	public function getTotalVistorLastDate() {
		$sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "customer_counter` WHERE TJD = subdate(current_date, 1)";
	...
	public function getTotalVistorAll() {
		$sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "customer_counter`";
